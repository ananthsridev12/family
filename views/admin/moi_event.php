  ...
  <div class="card-body p-0">
    <table class="table table-hover mb-0" style="font-size:.88rem;">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="11" class="text-center text-muted py-4">No entries yet. Click "+ Add Entry" to begin recording moi.</td>
        </tr>
        <?php endif; ?>
        ...
        <tr>
          ...
          <td><?= htmlspecialchars((string)($e['giver_relation'] ?? '—'), ENT_QUOTES, 'UTF-8') ?></td>
          <td><span class="badge <?= htmlspecialchars($badgeClass, ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($giftLabel, ENT_QUOTES, 'UTF-8') ?></span></td>
        ...
        <div class="modal-body">
          ...
          <div class="row g-3 mb-3">
            <div class="col-12 col-md-4">
              ...
              <input class="form-control" id="moiGiverName" name="giver_name" required
                     placeholder="e.g. Rajan Kumar">
            </div>
            <div class="col-12 col-md-4">
              <label class="form-label fw-600" for="moiFatherName">Father's Name</label>
          ...
          <div class="row g-3 mb-3">
            <div class="col-12 col-md-4">
              <label class="form-label fw-600" for="moiRelation">Relation</label>
              <input class="form-control" id="moiRelation" name="giver_relation"
                     placeholder="e.g. Uncle, Neighbour">
            </div>
            <div class="col-12 col-md-4">
