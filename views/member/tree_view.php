...
<div id="treeContainer" class="mt-4"
     ...
     data-profile-route="/index.php?route=<?= htmlspecialchars($routePrefix . '/person-view', ENT_QUOTES, 'UTF-8') ?>"
     data-wiki-route="/index.php?route=<?= htmlspecialchars($routePrefix . '/wiki-view', ENT_QUOTES, 'UTF-8') ?>"></div>
