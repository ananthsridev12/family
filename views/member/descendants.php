...
<h1 class="h4 mb-3">Descendants</h1>
<form method="get" action="/index.php" class="row g-3 mb-3">
  <?php $routePrefix = (string)($route_prefix ?? 'member'); ?>
  <input type="hidden" name="route" value="<?= htmlspecialchars($routePrefix . '/descendants', ENT_QUOTES, 'UTF-8') ?>">
  ...
  <div class="col-md-4 d-flex align-items-end">
    <button class="btn btn-primary" type="submit">Load Descendants</button>
  </div>
</form>
...
<div class="table-responsive">
  <table class="table table-sm table-striped">
    <thead>
      <tr><th>Generation</th><th>ID</th><th>Name</th><th>Gender</th></tr>
    </thead>
    <tbody>
      ...
      <?php endforeach; ?>
      <?php if (empty($rows ?? [])): ?>
      <tr><td colspan="4" class="text-muted">No descendant data for selected person.</td></tr>
      <?php endif; ?>
    </tbody>
  </table>
</div>
